...
namespace xafhangfire.Blazor.Server
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                builder.UseApplication<xafhangfireBlazorApplication>();
                ...
                builder.ObjectSpaceProviders
                    ...
                    .WithDbContext<xafhangfire.Module.BusinessObjects.xafhangfireEFCoreDbContext>((serviceProvider, options) =>
                    {
                ...
                builder.Security
                    .UseIntegratedMode(options =>
                    {
                        ...
                        options.UserType = typeof(xafhangfire.Module.BusinessObjects.ApplicationUser);
                        // ApplicationUserLoginInfo is only necessary for applications that use the ApplicationUser user type.
                        // If you use PermissionPolicyUser or a custom user type, comment out the following line:
                        options.UserLoginInfoType = typeof(xafhangfire.Module.BusinessObjects.ApplicationUserLoginInfo);
            ...
            services.AddSwaggerGen(c =>
            {
                ...
                {
                    Title = "xafhangfire API",
                    Version = "v1",
                    Description = @"Use AddXafWebApi(options) in the xafhangfire.Blazor.Server\Startup.cs file to make Business Objects available in the Web API."
                });
            ...
            services.Configure<ReportOutputOptions>(Configuration.GetSection("Reports"));
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                app.UseSwaggerUI(c =>
                {
                    c.SwaggerEndpoint("/swagger/v1/swagger.json", "xafhangfire WebApi v1");
                });
            }
            else
            {
