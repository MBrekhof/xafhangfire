...
namespace xafhangfire.Win
{
    public class ApplicationBuilder : IDesignTimeApplicationFactory
    {
        public static WinApplication BuildApplication(string connectionString)
        {
            ...
            builder.UseApplication<xafhangfireWindowsFormsApplication>();
            builder.Modules
                .AddCharts()
                .AddCloning()
                ...
                .Add<xafhangfireWinModule>();
            builder.ObjectSpaceProviders
                .AddSecuredEFCore(options =>
                {
                    options.PreFetchReferenceProperties();
                })
                    .WithDbContext<xafhangfire.Module.BusinessObjects.xafhangfireEFCoreDbContext>((application, options) =>
                    {
